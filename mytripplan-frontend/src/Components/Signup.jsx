  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        ...
        >
          <div className="h-full bg-blue-900 bg-opacity-70 flex items-center justify-center p-8">
            <div className="text-white text-center">
              <h2 className="text-3xl font-bold mb-4">Join Us Today!</h2>
              <p className="text-lg">Create an account to start your adventure.</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/home" className="text-gray-500 hover:text-gray-700 text-xl">
              &times;
            </Link>
          </div>
